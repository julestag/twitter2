...
?>
    ...
    <body>
        <div class="grid grid-col-2" style="display:flex">
            <div class="menu col-span-1 w-10xl p-5 text-align mx-7">
            ...
            <div class="bg-gray-100 rounded-2xl ml-10">
                <div class="container mx-9 my-9 m-8 py-9 px-60">
